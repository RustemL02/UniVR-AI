...
class CheckResult_val_iteration:
    ...
    def check_solution_env(self):
        ...
        CheckResult_val_iteration.check_solution(
...
class Main:
    if __name__ == "__main__":
        ...
        for name in env_names:
            ...
            solution = val_iteration(env)

            results = CheckResult_val_iteration(env, solution, name, name_index)
